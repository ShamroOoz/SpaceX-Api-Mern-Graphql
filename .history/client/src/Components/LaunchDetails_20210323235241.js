...
import { LAUNCH_Query } from "./QueryList";
    ...
    <div>
      <div className="flex ml-6 items-center mt-2">
        <div className="text-2xl font-bold text-gay-700">
          ...
          <span
            className={`${
              data.launch.success ? "text-green-600" : "text-red-600"
            }`}
          >
            {data.launch.name}
          </span>
            ...
            <div className="flex justify-between items-center h-16 pt-2  rounded-lg border border-gray-100 shadow-md">
              <div className="flex items-center">
                <div className=" ml-2 flex justify-around space-x-4">
                  ...
                  <div className="text-xl text-gray-600 truncate overflow">
                    {data.launch.details}
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center">
                <div className="ml-2 grid grid-cols-2 gap-8">
                  ...
                  <div className="text-xl text-gray-600 truncate ">
                    {data.launch.rocket.description}
                  </div>
                </div>
              </div>
            </div>
