...
const Launch = () => {
  ...
  return (
    <div class="min-h-screen flex-1 shadow-lg p-4 flex justify-center items-center">
      <div class="bg-white w-full md:max-w-4xl rounded-lg shadow">
        ...
        <div class="p-6 ">
          <button class="p-4 bg-green-400 hover:bg-green-500 w-full rounded-lg shadow text-xl font-medium uppercase text-white">
            Start the game
          </button>
        </div>
      </div>
